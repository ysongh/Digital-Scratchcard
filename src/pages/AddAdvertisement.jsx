  ...
  return (
    <div className='relative container mx-auto'>
      ...
      <div className='mt-3' style={{ maxWidth: '600px'}}>
        ...
        {isConnected && <button className='py-2 px-4 mt-3 text-white bg-secondarycolor rounded baseline hover:bg-secondarycolorhover' onClick={() => write?.()} disabled={isLoading || !url}>
          Create
        </button>}
